...
//               </div>
//             </div>
//             {/* Conditional Section: Add New Supplier */}
//             {values.showFields && (
  ...
  return (
    <div className="m-5">
      ...
      <div className="p-6 bg-white rounded-2xl border shadow-md max-w-4xl m-6">
        <Formik
          enableReinitialize // IMPORTANT: This tells Formik to update when initialValues change
          initialValues={initialValues}
          validationSchema={validationSchema}
          onSubmit={handleUpdate} // Use the new update handler
        >
          {({ resetForm, setFieldValue, values, touched, errors }) => (
            <Form className="space-y-8">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                  ...
                  {/* Supplier Dropdown (Add New functionality removed) */}
                  <div className="md:col-span-2">
                    <label
                      htmlFor="supplier_id"
                      className="font-semibold text-gray-700 block mb-2"
              ...
              {/* Item Details section remains mostly the same */}
              <div>
                <h2 className="text-xl font-bold text-gray-800 border-b pb-2 mb-6">
                  Item Details
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                  ...
                  {/* Quantity, Cost, Need Date fields... */}
                  <div>
                    <label
                      htmlFor="quantity"
                      className="font-semibold text-gray-700 block mb-2"
              ...
              {/* Form Actions with updated button text */}
              <div className="flex justify-end items-center gap-4 pt-6 border-t">
                <button
                  type="button"
                  className="text-gray-600 font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 flex items-center gap-2"
