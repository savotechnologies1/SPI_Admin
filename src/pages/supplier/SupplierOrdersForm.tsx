...
const SupplierOrdersForm = () => {
  ...
  return (
    <div className=" md:p-4 bg-white rounded-2xl border shadow-md">
      <form onSubmit={handleSubmit(onSubmit)} className="">
        ...
        {showFields && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  bg-white px-6 ">
            <div className="col-span-3 md:col-span-1">
        ...
        {/* Codes & Dates */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-4 bg-white px-6 ">
          <div className="col-span-3 md:col-span-1">
